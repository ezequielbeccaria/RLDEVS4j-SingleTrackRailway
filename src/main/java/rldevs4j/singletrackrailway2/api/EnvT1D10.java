 ...
 */
public class EnvT1D10 implements Runnable {
    ...
    public static void main(String[] args) {        
        ...
        EnvT1D10 exp = new EnvT1D10(agent);
    ...
    public EnvT1D10(ApiAgent agent) {
        this.agent = agent;
    ...
    @Override
    public void run() {
        EnvironmentFactory envFactory = new SimpleThreeStopsRailwayFactory(EPISODE_MAX_TIME, new double[]{10D*60D,0D,0D}, false,false);
