...
//        System.exit(0);
    ...
    public Env3A3CTrain() {
        super(0, "Env3A3CTrainCPU2", 1, false, true, "/home/ezequiel/experiments/SingleTrackRailwayEnv3/", null);
        ...
        double[] minFeatureValues = {0D, -22D, 0D, -22D, 0D, 0D, 0D, 0D, 0D, 0D, 0D, 0D, 0D, 0D, 0D, 0D, 0D, 0D, 0D, 0D, 0D, 0D, 0D, 0D, 0D};
        double[] maxFeatureValues = {14000D, 22D, 14000D, 22D, 2D, 2D, 2D, 2D, 2D, 2D, 2D, 2D, 2D, 2D, 1D, 1D, 1D, 1D, 1D, 1D, 1D, 1D, 1D, 1D, 1444};
