 ...
 */
public class Env3A3CTrain4 extends Experiment{
    ...
    public static void main(String[] args) {
        Experiment exp = new Env3A3CTrain4();
        exp.run();

//        System.exit(0);
    }

    public Env3A3CTrain4() {
        super(0, "Env3A3CTrainCPU_4", 1, false, true, "/home/ezequiel/experiments/SingleTrackRailwayEnv3/", null);
